...
export default function MinimalTheme({ portfolio }: any) {
  ...
  return (
    <div className="min-h-screen flex flex-col bg-white text-[#111827] antialiased selection:bg-gray-200">
      {/* 
        CustomCursor is intentionally excluded here to respect the strict Swiss / Apple rule:
        "Designer's personal website built by Apple" - No gimmick cursors. 
      */}
