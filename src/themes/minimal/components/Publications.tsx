        ...
        >
          {mobileMarqueeItems.map((pub: any, idx: number) => (
            <div
              ...
              className="w-full bg-[#FAFAFA] border border-gray-200 rounded-none p-4 flex items-center gap-4 shrink-0 cursor-pointer text-left transition-colors hover:bg-gray-50"
            >
              ...
              >
                <div>
                  <div className="w-full h-64 rounded-none overflow-hidden bg-white relative mb-5 border border-gray-200">
                    ...
                    {activePub.featured && (
                      <span className="absolute top-3 left-3 px-2.5 py-1 text-[9px] font-mono font-bold bg-[#111827] text-white uppercase tracking-widest">
                        FEATURED PRINTING
                      </span>
                    )}
                    ...
                    <div className="absolute bottom-3 left-3 right-3 flex items-center justify-between gap-4">
                      ...
                      <span className="flex items-center gap-1 text-[11px] font-mono font-bold text-[#111827] bg-white border border-gray-200 px-2.5 py-1 shrink-0">
                        <Calendar className="w-3.5 h-3.5 text-gray-400" /> {getYear(activePub.publicationDate)}
                      </span>
                    </div>
                  </div>
                  ...
                  {(activePub.journal || activePub.conference || activePub.publisher) && (
                    <div className="space-y-2.5 text-left px-1">
                      <div className="text-[10px] uppercase font-mono tracking-wider text-gray-400 font-bold">Distribution Channel Node</div>
                      <div className="flex flex-wrap gap-2">
                        {activePub.journal && (
                          <span className="px-2.5 py-1 bg-white border border-gray-200 text-xs font-bold text-gray-700 font-mono">
                        ...
                        {activePub.publisher && (
                          <span className="px-2.5 py-1 bg-white border border-gray-200 text-xs font-medium text-gray-500 font-mono">
                            {activePub.publisher}
                          </span>
                        )}
                      </div>
              ...
              <div className="p-6 sm:p-8 space-y-6">
                <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 p-4 bg-[#FAFAFA] border border-gray-200 font-sans">
                  ...
                  <div>
                    ...
                    <div className="text-xs font-mono font-bold text-gray-600 mt-1 flex items-center gap-1.5 truncate" title={selectedPub.doi || "No registered identifier Token"}>
