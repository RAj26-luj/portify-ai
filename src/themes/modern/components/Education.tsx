                ...
                <div className={`w-full sm:w-[46%] order-2 ${isEven ? "sm:order-1 sm:text-right" : "sm:order-3 sm:text-left"} flex flex-col`}>
                  ...
                  <div className="w-full bg-[#111113]/70 border border-[#18181B] hover:border-[#6366F1]/30 hover:bg-[#111113] p-5 md:p-6 rounded-2xl backdrop-blur-xl transition-all duration-300 shadow-[0_15px_30px_rgba(0,0,0,0.4),inset_0_1px_0_0_rgba(255,255,255,0.02)] relative overflow-hidden pl-14 sm:pl-6 space-y-4 text-left">
                    ...
                    <div className="absolute left-3 top-5 w-8 h-8 rounded-lg border border-[#18181B] bg-[#0A0A0B] overflow-hidden flex items-center justify-center sm:hidden shrink-0 shadow-inner p-1">
                      <img src={logo || DEFAULT_CAMPUS_IMAGE} alt="" className="w-full h-full object-contain" />
                    </div>
            ...
            >
              ...
              <div className="p-5 sm:p-8 space-y-6">
                <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 p-4 rounded-xl bg-[#0A0A0B]/60 border border-[#18181B] font-sans shadow-inner">
                  <div className="text-left">
                    <div className="text-[10px] font-bold text-[#71717A] uppercase tracking-wider font-mono">Enrollment Tenure</div>
                  ...
                  <div className="text-left">
                    <div className="text-[10px] font-bold text-[#71717A] uppercase tracking-wider font-mono">Field Matrix</div>
                    <div className="text-sm font-bold text-[#D4D4D8] mt-1 flex items-center gap-2 truncate" title={selectedItem.fieldOfStudy || "General Spec"}>
                      <BookOpen className="w-4 h-4 text-[#8B5CF6] shrink-0" />
                      <span className="truncate">{selectedItem.fieldOfStudy || "General Spec"}</span>
                    </div>
                  </div>
                  <div className="text-left">
                    <div className="text-[10px] font-bold text-[#71717A] uppercase tracking-wider font-mono">Performance Grade</div>
                ...
                {selectedItem.description && (
                  <div className="space-y-2 text-left">
                    <h4 className="text-[11px] font-bold text-[#71717A] tracking-wider uppercase font-mono">Syllabus Scope</h4>
                ...
                {selectedItem.location && (
                  <div className="pt-5 border-t border-[#18181B] flex items-center justify-between text-xs font-mono text-[#71717A]">
                    ...
                    <span className="opacity-40 flex items-center gap-1 font-mono text-xs font-semibold">
                      <Workflow className="w-3.5 h-3.5 text-[#8B5CF6]" /> {identityName} // EDU_SYNC_OK
                    </span>
                  </div>
                )}
              </div>
