            ...
            {mobileMarqueeItems.map((item: any, idx: number) => (
              ...
              >
                ...
                <div className="flex-1 min-w-0">
                  <h3 className="font-bold text-sm text-white truncate font-sans">{item.platform}</h3>
            ...
            {marqueeItems.map((item: any, idx: number) => (
              <div
                ...
                className={`bg-[#111113]/80 border border-[#18181B] hover:border-[#6366F1]/30 p-5 rounded-2xl backdrop-blur-xl transition-all duration-300 shadow-[0_20px_40px_rgba(0,0,0,0.4),inset_0_1px_0_0_rgba(255,255,255,0.02)] cursor-pointer hover:-translate-y-1 overflow-hidden group/card text-left ${
                  isScrollable ? "w-[330px] sm:w-[390px] shrink-0 inline-block" : "w-full"
                }`}
              >
                <div className="w-full h-52 rounded-xl overflow-hidden bg-[#18181B] mb-5 border border-[#18181B] relative flex items-center justify-center p-8 shadow-[inset_0_2px_8px_rgba(0,0,0,0.5)]">
                  <img
                    ...
                    className={`select-none transition-transform duration-700 max-h-24 object-contain group-hover/card:scale-105 ${
                      item.iconUrl ? "w-auto scale-110" : "w-full h-full object-cover opacity-10 blur-xs"
                    }`}
                  />
                  {!item.iconUrl && (
                ...
                <div className="grid grid-cols-2 gap-4">
                  {selectedItem.currentRating !== undefined && selectedItem.currentRating !== null && (
                    <div className="p-4 rounded-xl border border-[#18181B] bg-[#0A0A0B]/60 flex items-center gap-3 shadow-inner text-left">
                      ...
                      <div>
                        <div className="text-[10px] font-bold text-[#71717A] uppercase tracking-wider font-mono">Rating</div>
                        <div className="text-base font-extrabold text-white font-sans mt-0.5">{selectedItem.currentRating}</div>
                      </div>
                    </div>
                  )}
                  ...
                  {selectedItem.maxRating !== undefined && selectedItem.maxRating !== null && (
                    <div className="p-4 rounded-xl border border-[#18181B] bg-[#0A0A0B]/60 flex items-center gap-3 shadow-inner text-left">
                      ...
                      <div>
                        <div className="text-[10px] font-bold text-[#71717A] uppercase tracking-wider font-mono">Peak</div>
                        <div className="text-base font-extrabold text-amber-500 font-sans mt-0.5">{selectedItem.maxRating}</div>
                      </div>
                    </div>
                  )}
                  ...
                  {selectedItem.problemsSolved !== undefined && selectedItem.problemsSolved !== null && (
                    <div className="p-4 rounded-xl border border-[#18181B] bg-[#0A0A0B]/60 flex items-center gap-3 shadow-inner text-left">
                      ...
                      <div>
                        <div className="text-[10px] font-bold text-[#71717A] uppercase tracking-wider font-mono">Solved</div>
                        <div className="text-base font-extrabold text-white font-sans mt-0.5">{selectedItem.problemsSolved}</div>
                      </div>
                    </div>
                  )}
                  ...
                  {selectedItem.contestsAttended !== undefined && selectedItem.contestsAttended !== null && (
                    <div className="p-4 rounded-xl border border-[#18181B] bg-[#0A0A0B]/60 flex items-center gap-3 shadow-inner text-left">
                      ...
                      <div>
                        <div className="text-[10px] font-bold text-[#71717A] uppercase tracking-wider font-mono">Contests</div>
                        <div className="text-base font-extrabold text-white font-sans mt-0.5">{selectedItem.contestsAttended}</div>
                      </div>
                    </div>
                  )}
                </div>
