...
export default function Projects({ projects = [], username }: ProjectsProps) {
  ...
  const [selectedProject, setSelectedProjectState] = useState<any | null>(null);
  const [isPaused, setIsPaused] = useState<boolean>(false);
  const [hoveredImageIndex, setHoveredImageIndex] = useState<number>(0);
  
  const selectedProjectRef = useRef<any | null>(null);
  const setSelectedProject = (proj: any) => {
  ...
  const startMobileMarquee = async (fromY: number) => {
    ...
    if (!isDraggingMobile.current && !selectedProjectRef.current && isMountedRef.current) {
      ...
      <div className="relative max-w-7xl mx-auto px-6 sm:px-8 lg:px-16 z-10 mb-16 md:mb-24">
        <div className="flex flex-col lg:flex-row lg:items-end justify-between gap-4 border-b border-gray-100 pb-6 text-left">
          <div className="text-left">
            ...
            <h2 className="text-3xl md:text-5xl font-black tracking-tight bg-gradient-to-b from-white via-[#D4D4D8] to-[#71717A] bg-clip-text text-transparent font-sans uppercase">
        ...
        >
          {mobileMarqueeItems.map((project: any, idx: number) => (
            <div
              ...
              className="w-full bg-[#111113] border border-[#18181B] active:border-[#6366F1]/50 rounded-xl p-4 flex items-center gap-4 cursor-pointer text-left shrink-0 transition-colors hover:bg-gray-50"
            >
            ...
            {validProjects.map((project: any, idx: number) => {
              ...
              return (
                <div
                  ...
                  className={`w-full text-left p-4 rounded-xl cursor-pointer transition-all duration-200 relative border group h-[105px] flex flex-col justify-center ${
                    isCurrent 
            ...
            {activeProject && (
              ...
              >
                ...
                <div className="pt-6 mt-6 border-t border-[#18181B] flex items-center justify-end gap-3.5" onClick={(e) => e.stopPropagation()}>
                  <span className="text-xs font-mono font-bold text-gray-400 uppercase tracking-wide mr-auto">
          ...
          >
            ...
            >
              ...
              <div className="p-5 sm:p-8 space-y-6">
                <div className="grid grid-cols-1 sm:grid-cols-4 gap-4 p-4 rounded-xl bg-[#0A0A0B]/60 border border-[#18181B] shadow-inner text-left">
                  <div>
                  ...
                  {selectedProject.metrics?.length > 0 && (
                    <div className="sm:col-span-2">
                      ...
                      <div className="flex flex-wrap gap-2.5 mt-1.5 text-left">
