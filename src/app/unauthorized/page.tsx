    ...
    <main className="flex min-h-screen items-center justify-center bg-[#0A0A0A] px-3 xs:px-4 py-8 antialiased selection:bg-red-500/20 selection:text-white relative overflow-hidden">
      ...
      <div className="w-full max-w-[340px] xs:max-w-sm sm:max-w-md rounded-xl sm:rounded-2xl border border-white/5 border-t-white/[0.08] bg-[#111111] p-4 xs:p-5 sm:p-8 text-center shadow-[0_12px_40px_rgba(0,0,0,0.8)] relative z-10 transition-all duration-300 hover:border-white/10 group">
        ...
        <p className="text-[11px] sm:text-sm text-zinc-400 leading-relaxed max-w-xs mx-auto font-sans px-0.5 mb-4">
          Your account status profile indicates an active administrative restriction, request
          rejection, or structural access blockade on this workspace platform cluster.
        </p>
        ...
        <div className="space-y-2.5 text-left my-4 sm:my-6">
            ...
            <div className="flex items-start gap-2.5">
              ...
              <div className="space-y-0.5">
                ...
                <p className="text-[10px] sm:text-[11px] text-zinc-400 leading-normal font-sans">
                  A comprehensive structural rejection or account status lock notification breakdown
                  dispatch has been processed. Due to systemic routing filters, this message might
                  reside inside your <strong className="text-zinc-200 font-medium">Spam</strong>,{" "}
                  <strong className="text-zinc-200 font-medium">Junk</strong>, or{" "}
                  <strong className="text-zinc-200 font-medium">Promotions</strong> directories.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="rounded-lg bg-amber-500/[0.01] border border-amber-500/10 p-3 sm:p-4 relative overflow-hidden">
            <div className="flex items-start gap-2.5">
              <AlertCircle
                size={14}
                className="text-amber-400 mt-0.5 shrink-0 sm:w-[16px] sm:h-[16px]"
              />
              <div className="space-y-0.5">
                ...
                <p className="text-[10px] sm:text-[11px] text-zinc-400 leading-normal font-sans">
                  To secure crucial delivery pipelines and allow direct appeals to reach your inbox
                  safely, open the status email inside your mail engine and explicitly tap{" "}
                  <strong className="text-amber-400 font-medium">"Report Not Spam"</strong>.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="rounded-lg bg-white/[0.02] border border-white/5 p-3 sm:p-4 relative overflow-hidden">
            <div className="flex items-start gap-2.5">
              <HelpCircle
                size={14}
                className="text-zinc-400 mt-0.5 shrink-0 sm:w-[16px] sm:h-[16px]"
              />
              <div className="space-y-0.5">
                ...
                <p className="text-[10px] sm:text-[11px] text-zinc-400 leading-normal font-sans">
                  If you firmly believe this security status flags an erroneous baseline calculation
                  or data mistake, please reply directly to the system support mail coordinate
                  referenced in our status dispatch.
                </p>
              </div>
            </div>
          </div>
