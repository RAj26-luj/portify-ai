...
export default function AdminDashboardPage() {
  ...
  const stats = [
    ...
    {
      label: "Approved",
      value: data.stats.approvedUsers.toLocaleString(),
      icon: <ShieldCheck size={14} />,
    },
    {
      label: "Pending",
      value: data.stats.pendingUsers.toLocaleString(),
      icon: <Clock size={14} />,
    },
    {
      label: "Portfolios",
      value: data.stats.totalPortfolios.toLocaleString(),
      icon: <Layers size={14} />,
    },
  ];
    ...
    <div className="max-w-7xl mx-auto px-3 sm:px-4 py-6 space-y-6">
      ...
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-3">
        {stats.map((s) => (
          <div
            key={s.label}
            className="bg-[#111113] border border-white/5 rounded-xl p-4 transition-all hover:border-white/10"
          >
            ...
            <div className="p-4 border border-white/5 rounded-lg bg-[#111113]/50">
              ...
              <div className="grid sm:grid-cols-2 gap-3">
                <button
                  ...
                  className="p-4 border border-white/5 rounded-lg text-left hover:bg-[#1A1A1D] transition-all"
                >
