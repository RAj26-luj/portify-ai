    ...
    >
      ...
      <div className="bg-[#121214] border border-white/5 rounded-lg p-3 sm:p-4 mb-1">
        ...
        <p className="text-[11px] text-zinc-400 leading-relaxed font-sans">
          Establish or modify an analytical grouping layer (e.g. &quot;Languages&quot;, &quot;Full-Stack Frameworks&quot;, &quot;Robotics & Locomotion&quot;) to systematically partition your technological competencies array.
        </p>
      </div>
      ...
      <div className="space-y-1 group/input">
        <label className={labelStyle}>
          <span className="flex items-center gap-1">Category Label Name <span className="text-red-400 font-sans font-bold">*(Required)</span></span>
        ...
        <input
          ...
          disabled={loading}
        />
        <span className={descriptionStyle}>Provide a distinctive classification tracking title string to organize subset technical tokens.</span>
      </div>
